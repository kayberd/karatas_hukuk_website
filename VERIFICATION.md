...
| 14 | http://localhost:4321/bilgi-bankasi | [ ] |
| 15 | http://localhost:4321/bilgi-bankasi/anlasmali-bosanma-sureci | [ ] |
| 16 | http://localhost:4321/bilgi-bankasi/pomem-saglik-raporu-sureci | [ ] |
| 17 | http://localhost:4321/bilgi-bankasi/sorusturma-asamasinda-supheli-haklari | [ ] |
| 18 | http://localhost:4321/bilgi-bankasi/trafik-kazasi-tazminat | [ ] |
| 19 | http://localhost:4321/bilgi-bankasi/vekaletname-turleri | [ ] |
| 20 | http://localhost:4321/bilgi-bankasi/kategori/aile | [ ] |
| 21 | http://localhost:4321/bilgi-bankasi/kategori/ceza | [ ] |
| 22 | http://localhost:4321/bilgi-bankasi/kategori/genel-hukuk | [ ] |
| 23 | http://localhost:4321/bilgi-bankasi/kategori/idari-yargi | [ ] |
| 24 | http://localhost:4321/bilgi-bankasi/kategori/tazminat | [ ] |
...
### `/bilgi-bankasi` (liste) → http://localhost:4321/bilgi-bankasi
...
- [ ] Trafik kazası tazminat (tazminat) → http://localhost:4321/bilgi-bankasi/trafik-kazasi-tazminat
- [ ] Soruşturmada şüpheli hakları (ceza) → http://localhost:4321/bilgi-bankasi/sorusturma-asamasinda-supheli-haklari
- [ ] Anlaşmalı boşanma süreci (aile) → http://localhost:4321/bilgi-bankasi/anlasmali-bosanma-sureci
- [ ] POMEM sağlık raporu (idari-yargi) → http://localhost:4321/bilgi-bankasi/pomem-saglik-raporu-sureci
- [ ] Vekaletname türleri (genel-hukuk) → http://localhost:4321/bilgi-bankasi/vekaletname-turleri
- [ ] FAQ varsa açılır/şema (FAQPage JSON-LD) doğru
- [ ] Geçersiz slug → http://localhost:4321/bilgi-bankasi/xxx → 404

### Kategori sayfaları — açılıyor, sadece o kategori yazıları:
- [ ] Tazminat Hukuku → http://localhost:4321/bilgi-bankasi/kategori/tazminat
- [ ] Ceza Hukuku → http://localhost:4321/bilgi-bankasi/kategori/ceza
- [ ] Aile Hukuku → http://localhost:4321/bilgi-bankasi/kategori/aile
- [ ] İdari Yargı → http://localhost:4321/bilgi-bankasi/kategori/idari-yargi
- [ ] Genel Hukuk → http://localhost:4321/bilgi-bankasi/kategori/genel-hukuk
- [ ] Genel Hukuk tek yazı içeriyor (doğru filtre)
- [ ] Geçersiz kategori → http://localhost:4321/bilgi-bankasi/kategori/xxx → 404
...
- Statik (sitemap): 9 (`/`, hakkimizda, iletisim, avukatlar, faaliyet-alanlari, bilgi-bankasi, kvkk-aydinlatma, gizlilik, cerez-politikasi)
- Avukat profili: 1
- Faaliyet alanı detay: 7
- Bilgi bankası yazı: 5
- Kategori: 5
